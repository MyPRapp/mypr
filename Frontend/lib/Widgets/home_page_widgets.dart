  ...
  Widget build(BuildContext context) {
    return Consumer<ClubProvider>(
      builder: (context, clubProvider, child) {
        bool isLiked = clubProvider.isLiked(clubName);
        return Stack(
          children: [
            GestureDetector(
              onTap: () {
                AutoRouter.of(context)
                    .push(ReservationRoute(clubName: clubName));
              },
              child: Padding(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image:
                                AssetImage('assets/clubPhotos/$clubName.jpg'),
                          ),
                        ),
                      ),
                      SizedBox(
            ...
            Padding(
              ...
              child: LikeButton(
                clubID: clubProvider.getClubIDByName(clubName),
                onRemove: onRemove,
                clubName: clubName,
                liked: isLiked,
              ),
